...
class Player:
    def __init__(self, win):
        self.win = win
        self.image = pygame.image.load(os.path.join(script_dir, "Assets/red.png"))
        self.image = pygame.transform.scale(self.image, (44, 44))
        self.reset()
        self.collected_balls = []  # Initialize the list here
...
class Ball(pygame.sprite.Sprite):
    ...
    def reset_position(self):
        # Add your logic here to reset the position of the ball
        pass
...
class Block(pygame.sprite.Sprite):
	def __init__(self, x, y, max, win):
		...
		self.orig = pygame.image.load(os.path.join(script_dir, "Assets/block.jpeg"))
...
class ScoreCard:
	def __init__(self, x, y, win):
		...
		self.style = os.path.join(script_dir, "Fonts/BubblegumSans-Regular.ttf")
